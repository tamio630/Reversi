...
public class Computer : MonoBehaviour {
    ...
    private static int predict=4;//先読みターン数
    ...
    {
        if ((array[1, 4] == turn) && (array[1, 5] == turn) && (array[1, 3] == Get_enemy_turn(turn)) && (array[1, 6] == Get_enemy_turn(turn))){
            return 0.5;
        }
        else if ((array[4, 1] == turn) && (array[5, 1] == turn) && (array[3, 1] == Get_enemy_turn(turn)) && (array[6, 1] == Get_enemy_turn(turn))){
            return 0.5;
        }
        else if ((array[8, 4] == turn) && (array[8, 5] == turn) && (array[8, 3] == Get_enemy_turn(turn)) && (array[8, 6] == Get_enemy_turn(turn))){
            return 0.5;
        }
        else if ((array[4, 8] == turn) && (array[5, 8] == turn) && (array[3, 8] == Get_enemy_turn(turn)) && (array[6, 8] == Get_enemy_turn(turn))){
            return 0.5;
        }
    ...
    {
        if ((array[2, 8] == Get_enemy_turn(turn)) && (array[3, 8] == Get_enemy_turn(turn)) && (array[4, 8] == Get_enemy_turn(turn)) && (array[5, 8] == Get_enemy_turn(turn)) && (array[6, 8] == turn) && (array[7, 8] == Get_enemy_turn(turn)))
        {
            return 0.6;
        }
        else if ((array[2, 8] == Get_enemy_turn(turn)) && (array[3, 8] == turn) && (array[4, 8] == Get_enemy_turn(turn)) && (array[5, 8] == Get_enemy_turn(turn)) && (array[6, 8] == Get_enemy_turn(turn)) && (array[7, 8] == Get_enemy_turn(turn)))
        {
            return 0.6;
        } else if ((array[8, 2] == Get_enemy_turn(turn)) && (array[8, 3] == Get_enemy_turn(turn)) && (array[8, 4] == Get_enemy_turn(turn)) && (array[8, 5] == Get_enemy_turn(turn)) && (array[8, 6] == turn) && (array[8, 7] == Get_enemy_turn(turn))){
            return 0.6;
        }else if((array[8, 2] == Get_enemy_turn(turn)) && (array[8, 3] == Get_enemy_turn(turn)) && (array[8, 4] == Get_enemy_turn(turn)) && (array[8, 5] == Get_enemy_turn(turn)) && (array[8, 6] == turn) && (array[8, 7] == Get_enemy_turn(turn)))
        {
            return 0.6;
    ...
    /*
    private double get_pattern_value3(int[,] array, int turn)
    {
        if ((array[3, 5] == turn) && (array[4, 5] == turn) && (array[4, 4] == Get_enemy_turn(turn)) && (array[4, 6] == turn) && (array[5, 4] == turn) && (array[5, 5] == turn) && (array[5, 6] == turn))//ねずみ
        { 
        }
    }

    private double get_pattern_value4(int[,] array, int turn)  //ねずみ
    {
        if ((array[3, 5] == turn) && (array[4, 5] == turn) && (array[4, 4] == Get_enemy_turn(turn)) && (array[4, 6] == turn) && (array[5, 4] == turn) && (array[5, 5] == turn) && (array[5, 6] == turn))
        {
        }
    }

    private double get_pattern_value5(int [,] array,int turn) //うさぎ
    {
        if ((array[4, 4] == Get_enemy_turn(turn)) && (array[4, 5] == turn) && (array[5, 4] == turn) && (array[5, 5] == turn) && (array[5, 6] == turn) && (array[6, 3] == turn) && (array[6, 4] == Get_enemy_turn(turn)))
        {
        }
        else if ((array[4, 4] == Get_enemy_turn(turn)) && (array[4, 5] == turn) && (array[5, 3] == turn) && (array[5, 4] == turn) && (array[5, 5] == turn) && (array[5, 6] == turn) && (array[6, 4] == Get_enemy_turn(turn))){
            
        }
    }

    private double get_pattern_value6(int [,] array,int turn) //とら
    {
        if ((array[3, 3] == turn) && (array[4, 4] == turn) && (array[4, 5] == turn) && (array[5, 4] == Get_enemy_turn(turn)) && (array[5, 5] == turn) && (array[5, 6] == turn) && (array[6, 4] == Get_enemy_turn(turn)))
        {
        }
        else if ((array[4, 3] == turn) && (array[4, 4] == turn) && (array[4, 5] == turn) && (array[5, 4] == Get_enemy_turn(turn)) && (array[5, 5] == turn) && (array[5, 6] == turn) && (array[6, 4] == Get_enemy_turn(turn)))
        {
        }
    }

    private double get_pattern_value7(int[,] array, int turn) //うし
    {
        if ((array[4, 4] == Get_enemy_turn(turn)) && (array[4, 5] == Get_enemy_turn(turn)) && (array[4, 6] == Get_enemy_turn(turn)) && (array[5, 4] == turn) && (array[5, 5] == turn) && (array[5, 6] == Get_enemy_turn(turn)) && (array[6, 5] == turn) && (array[6, 6] == Get_enemy_turn(turn)))
        {
        }
    }

   private double get_pattern_value(int [,] array,int turn)
    {
        if (array[1, 1] == Get_enemy_turn(turn))
        {
            return 0.5;
        }
    }*/
    ...
    int[] Deep_reading(int turn)
    {
        ...
        Reverse(able_list[0][0], able_list[0][1], turn, number_of_turn, copyArray);
        copyArray[able_list[0][0], able_list[0][1]] = turn;
        max_value = Deep_reading2(copyArray, Get_enemy_turn(turn)); //相対評価　自分の評価ー相手の評価
        foreach (int[] array in able_list)
        {
            copyArray = CopyArray(putMass);
            Reverse(array[0], array[1], turn, number_of_turn, copyArray);
    ...
    private double Deep_reading2(int[,] mass_Status,int turn,int n)
    {
        ...
        if (able_list.Count == 0)
        {
            ...
            if (able_list.Count == 0)
            {
                return get_stone_count(mass_Status, this.turn) - get_stone_count(mass_Status, Get_enemy_turn(this.turn)) * 10000;
            }
        }
